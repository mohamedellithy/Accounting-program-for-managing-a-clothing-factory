        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">عدد المدينين</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">اجمالى مبلغ المدينين</span>
                <span class="info-box-number">
                ...
                @endif
                    <div class="card">
                      <div class="card-header">
                        <h3 class="card-title">عرض المدينين</h3>
                      </div>
                        ...
                        <div id="merchantsContainer" class="card-body">
                            <h2 id="heading_print" style="display:none" > جدول المدينين </h2>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">تأكيد حذف المدينين</h4>
