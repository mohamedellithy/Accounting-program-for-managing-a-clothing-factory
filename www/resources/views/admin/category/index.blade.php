        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-danger elevation-1"><i class="fa fa-hourglass"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">اصناف المنتهية</span>
                <span class="info-box-number"><label style="font-weight:200"> القماش : </label>   {{($category_finished_order_count?$category_finished_order_count:'0')}} </span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-success elevation-1"><i class="fa fa-hourglass"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">اصناف المنتهية</span>
                <span class="info-box-number"><label style="font-weight:200"> المنتجات : </label>    {{($category_finished_order_count?$category_finished_order_count:'0')}} </span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">مضافة مؤخرا</span>
                <span class="info-box-number">  {{($categories_last_added?$categories_last_added:'0')}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <!-- /.col -->
      	  <div class="col-12">
             <form id="form_delete_select" action="{{ url('delete-select-category') }}"  method="POST">
	             {{ csrf_field() }}
		            ...
		            @endif
      		          <div class="card">
      		            <div class="card-header">
      		              <h3 class="card-title">عرض الاصتاف</h3>
      		            </div>
      		              <div class="operations-buttons">
        			            <div class="btn-group ">
                                  ...
                                  <button id="" type="submit" class="dropdown-item delete" data-toggle="modal" data-target="#modal-default" > <i class="far fa-trash-alt"></i> حذف المحدد</button>
        		                      <div class="dropdown-divider"></div>
        		                      <a class="dropdown-item delete_all" href="{{ url('delete-category') }}"  data-toggle="modal" data-target="#modal-default" > <i class="far fa-trash-alt"></i> حذف الكل</a>
                            ...
                            <h2 id="heading_print" style="display:none" > جدول الاصناف </h2>
      			                <table id="merchants" class="table table-bordered table-hover">
      				                <thead>
      					                <tr>
      					                  <th></th>
      					                  <th>اسم الصنف</th>
                                  <th>عدد الطلبات / المنتجات</th>
      					                  <th>تاريخ الانشاء </th>
      					                  <th>اجراءات</th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">تأكيد حذف تصنيف</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
              </button>
            </div>
            <div class="modal-body">
              <p>تأكيد حذف المحدد من جدول التصنيفات</p>
            </div>
