...
@section('title', 'عرض شيكات المبيعات')

@section('content_header')
    <h1> عرض شيكات المبيعات </h1>
@stop
                ...
                @endif
                    <div class="card">
                      <div class="card-header">
                        <h3 class="card-title">عرض شيكات المبيعات</h3>
                      </div>
                        ...
                        <div id="merchantsContainer" class="card-body">
                            <h2 id="heading_print" style="display:none" > جدول شيكات المبيعات </h2>
  ...
  <script src="{{ asset('vendor/adminlte/plugins/plugins/datatables-bs4/js/dataTables.bootstrap4.js') }}"></script>
   ...
   jQuery(document).ready( function () {
          jQuery('#merchants').DataTable({
             processing: true,
             serverSide: true,
             ajax: "{{ url('datatable-check-orders') }}",
             columns: [
