...
@section('title', 'عرض فواتير القماش')

@section('content_header')
    <h1> عرض فواتير قماش </h1>
@stop
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">طلبات نقدية</span>
                <span class="info-box-number">
                 {{ ($orderClothes_cash?$orderClothes_cash:'0') }}
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">طلبات بشيكات</span>
                <span class="info-box-number">
                  {{ ($orderClothes_check?$orderClothes_check:'0') }}
                </span>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">طلبات بدفعات</span>
                <span class="info-box-number">
                  {{ ($orderClothes_postponed?$orderClothes_postponed:'0') }}
                </span>
              </div>
              <!-- /.info-box-content -->
            </div>
