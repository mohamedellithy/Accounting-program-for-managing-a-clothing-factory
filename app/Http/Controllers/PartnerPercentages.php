        ...
        ->addColumn('process', function($row) {
                 return '<div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              ...
                              <a class="dropdown-item " href="'.url('partner-edite/'.$row->id).'"> <i class="fas fa-pencil-alt"></i>  تعديل </a>      
                            </div>  
                        </div>';

            })->addColumn('show', function($row) {
                   return '<a href='.url('single-partner/'.$row->id).' class="btn btn-success btn-sm">عرض </a>';                
